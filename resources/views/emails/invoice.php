    ...
    <div class="container" style="font-family: 'Century Gothic', Tahoma, Arial;">
        ...
        <div class="hiremainbox">
            ...
            <div class="hireorderdetail" style="margin-top: 15px;">
                ...
                {order_details}
                <div class="hireordata hiretotal" style="margin:0 0 7px 0; margin: 10px 0 7px 0; color: #144D5C; border-top: 1px solid #ddd; padding: 10px 0 0 0; font-size: 16px; font-weight: bold;"><span><?php echo JText::_('VRLIBSIX'); ?></span>
                    <div style="float:right;"><strong>{order_total}</strong></div>
                </div>
                {order_deposit}
                {order_total_paid}
            </div>
