...
<head>
    ...
    <title>Nova reserva na plataforma CR Rent</title>
...
<body>
    ...
    <div class="vrc-emailc-wrap"
        ...
        <div class="container" style="font-family: 'Century Gothic', Tahoma, Arial;">
            <p class="Stile1" style="font-size: 18px; font-weight: bold;">CR Rent</p>
            <div class="statusorder"
                style="display: flex; flex-wrap: wrap; border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; margin-bottom: 15px;">
                ...
                <div class="boxstatusorder" style="padding:10px; margin:0 5px 10px 0; flex: 1;">
                    ...
                    <span style="font-weight: bold;"
                        class="vrc-email-summ-values vrc-email-summ-status {order_status_class}">{{$reservation->confirmed_at}}</span>
                </div>
                <div class="boxstatusorder" style="padding:10px; margin:0 5px 10px 0; flex: 1;">
                    <span class="vrc-email-summ-lbl"
                        style="display: block; font-weight: bold; margin-bottom: 2px; font-size: 1.1em;">
            ...
            <div class="hiremainbox">
                <h4 style="font-size: 18px; font-weight: bold; margin-bottom: 12px;">
                    Vehicle: {{$reservation->car->category->title}}
                </h4>
                <div class="hirecar" style="display: flex; flex-wrap: wrap;">
                    <div class="hiredate"
                        ...
                        <p style="padding: 0; margin: 0px 0 5px; display: inline-block; margin-right: 10px;">
                            ...
                            <span class="Stile9" style="font-size: 14px;">{{$reservation->pickup_date}}</span>
                        </p>
                        <p style="padding: 0; display: inline-block;">
                            <span class="Stile12" style="font-size: 14px;font-weight: bold;">
                                Pickup Location
                            </span>
                            <span class="Stile9" style="font-size: 14px;">{{$reservation->pickup_place}}</span>
                        </p>
                    </div>
                    <div class="hiredate"
                        style="flex: 1; border:1px solid #eee; border-radius:4px; padding:10px; margin:0 10px 0 0; background:#fbfbfb;">
                        <p style="padding: 0; margin: 0px 0 5px; display: inline-block; margin-right: 10px;">
                            ...
                            <span class="Stile9" style="font-size: 14px;">{{$reservation->return_date}}</span>
                        </p>
                        <p style="padding: 0; display: inline-block;">
                            <span class="Stile12" style="font-size: 14px;font-weight: bold;">
                                Drop Off Location
                            </span>
                            <span class="Stile9" style="font-size: 14px;">{{$reservation->return_place}}</span>
                        </p>
                    </div>
                </div>
                <div class="hireorderdetail" style="margin-top: 15px;">
                    ...
                    <div class="hireordata hiretotal"
                        ...
                        <div style="float:right;"><strong>{{$reservation->price}}</strong></div>
                    </div>
                </div>
                <div class="vrc-emailc-footer smalltext" style="margin-top: 35px; font-size:12px;">
                    <strong>
                        To see your order details, visit the following page:
                    </strong><br />
                    https://vikwp.com/demo/vikrentcar/your-rental-order/?sid=1905742021&ts=1675017383
