export const text = {
    ...
    about: {
        ...
        paragraph: ["CRRent found in car rental, without a driver, a way to contribute to the support and development of tourism on the island of Madeira.", "Having customer satisfaction as its main objective, CR Rent provides human support personalized service, a new and recent fleet, with attractive prices."],
    },
    faq: [
        { question: "What are the minimum requirements for renting a car at CR Rent?", answer: "The minimum rental period is 24 hours, while the minimum age is 21 years old and have a driving license for more than 1 year." },
        ...
        { question: "What documents do I need to rent a vehicle?", answer: "To be able to rent a vehicle at CR Rent you need a valid driving license, identity card or passport and credit card for rentals with a deposit or deductible." },
